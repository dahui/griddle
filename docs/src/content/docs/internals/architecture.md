---
title: Architecture
description: How Griddle is put together — crates, packages, and where decisions live.
sidebar:
  order: 1
---
...
The frontend never decides anything. Commands return a typed error carrying a *kind* — so
"Steam is running, close it" stays distinguishable from "the network timed out" — and an action
